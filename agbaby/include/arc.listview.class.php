...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<li><span class=\"pageinfo\"> <strong>1 /</strong><strong>".$this->TotalResult."</strong></span></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li><span class=\"pageinfo\"> <strong>0 /</strong><strong>".$this->TotalResult."</strong></span></li>\r\n";
        }
        $purl = $this->GetCurUrl();
        $maininfo = "<li><span class=\"pageinfo\"> <strong>{$totalpage}</strong><strong>".$this->TotalResult."</strong></span></li>\r\n";
        ...
        {
            $indexpage="<li><a style=\"color:#fd6d04;\">Index</a></li>\r\n";
        }
        ...
        {
            $endpage="<li><a style=\"color:#fd6d04;\">Last</a></li>\r\n";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<li class=\"thisclass\"><a style=\"color:#fd6d04;\">$j</a></li>\r\n";
            }
            else
            {
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<li><span class=\"pageinfo\">1 /".$this->TotalResult." </span></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li><span class=\"pageinfo\"> 0 /".$this->TotalResult." </span></li>\r\n";
        }
        $maininfo = "<li><span class=\"pageinfo\"> <strong>{$totalpage}</strong><strong>".$this->TotalResult."</strong></span></li>\r\n";
