...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg .= "<div style='padding:6px;font-size:12px;border-bottom:1px solid #DADADA;background:#DBEEBD url({$GLOBALS['cfg_plus_dir']}/img/wbg.gif)';'><b>Prompt Message！</b></div>\");\r\n";
        ...
        if($onlymsg==0)
        {
            ...
            {
                $rmsg .= "<br /><a href='{$gourl}'>If your browser doesn't respond, click here...</a>";
                $rmsg .= "<br/></div>\");\r\n";
